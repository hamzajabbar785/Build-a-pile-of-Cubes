...
// of n3 , the cube above will have volume of (n-1)3 and so on until the top which will have a volume of 13
...
// to return the integer n such as n3 + (n-1)3 + (n-2)3 + .... + 13 = m  if such a n exists or -1 if there 
// is no such n.
...
const findNb = (m) => {
    ...
    return Math.sign(m) === -1 ? -1 : counter
}
